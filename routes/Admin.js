...
router.get('/update-request', verifyUser, adminOnly, async (req, res) => {
    try {
        ...
        res.json({ status: 'success', data: {update_requests} })
    } catch (error) {
...
router.get('/update-request/:update_requestId', verifyUser, adminOnly, async (req, res) => {
    try {
        ...
        res.json({ status: 'success', data: {update_request} })
    } catch (error) {
...
router.put('/password/:userId', verifyUser, adminOnly, async (req, res) => {
    try {
        ...
        return res.json({ status: 'success', message: 'Password berhasil diubah oleh admin', data: {new_password} })
    } catch (error) {
